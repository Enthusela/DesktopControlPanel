...
#define FILE_NAME "argb_dev_subrng"
...
void setup() {
  ...
  lcd.clear();
  delay(1000);
  FastLED.addLeds<DEV1_LED_TYPE,DEV1_PIN_DATA>(dev1LEDs,DEV1_LED_NUM);//,DEV1_LED_COLOR_ORDER>(dev1LEDs,DEV1_LED_NUM);
